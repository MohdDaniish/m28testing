...
const autopool = require("./model/autopool");
const m28userplace = require("./model/m28userplace");
...
app.use("/centralize/api", routes);
app.use("/centralize/api", AuthRouter);
app.use("/centralize/api", Adminlogin);
app.use("/centralize/api", Dashboard);
app.use("/centralize/api", express.static(path.join(__dirname, "/public/upload")));
...
const ABI = [{"anonymous":false,"inputs":[{"indexed":false,"internalType":"uint8","name":"packageId","type":"uint8"},{"indexed":false,"internalType":"uint8","name":"poolId","type":"uint8"},{"indexed":false,"internalType":"uint256","name":"usdAmount","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"POLCoinAmt","type":"uint256"}],"name":"CreateWalletFund","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"sender","type":"address"},{"indexed":true,"internalType":"address","name":"receiver","type":"address"},{"indexed":false,"internalType":"uint256","name":"amount","type":"uint256"},{"indexed":false,"internalType":"uint8","name":"packageId","type":"uint8"},{"indexed":false,"internalType":"uint256","name":"level","type":"uint256"}],"name":"GlobalDownlineIncome","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"sender","type":"address"},{"indexed":true,"internalType":"address","name":"receiver","type":"address"},{"indexed":false,"internalType":"uint256","name":"amount","type":"uint256"},{"indexed":false,"internalType":"uint8","name":"packageId","type":"uint8"},{"indexed":false,"internalType":"uint256","name":"level","type":"uint256"}],"name":"GlobalUplineIncome","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"user","type":"address"},{"indexed":false,"internalType":"uint256","name":"packageId","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"expiry","type":"uint256"}],"name":"M28Buy","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"sender","type":"address"},{"indexed":true,"internalType":"address","name":"reciever","type":"address"},{"indexed":false,"internalType":"uint8","name":"packageId","type":"uint8"},{"indexed":false,"internalType":"uint256","name":"amount","type":"uint256"}],"name":"M28SponcerIncome","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"user","type":"address"},{"indexed":true,"internalType":"address","name":"referrer","type":"address"},{"indexed":false,"internalType":"uint256","name":"place","type":"uint256"},{"indexed":false,"internalType":"uint8","name":"packageId","type":"uint8"}],"name":"M28UserPlace","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"user","type":"address"},{"indexed":true,"internalType":"address","name":"referrer","type":"address"},{"indexed":false,"internalType":"uint8","name":"packageId","type":"uint8"},{"indexed":false,"internalType":"uint256","name":"poolId","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"place","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"cycle","type":"uint256"}],"name":"NewUserPlace","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"user","type":"address"},{"indexed":false,"internalType":"uint8","name":"packageId","type":"uint8"},{"indexed":false,"internalType":"uint256","name":"usdAmount","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"POLCoinAmt","type":"uint256"}],"name":"PackageBuy","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"user","type":"address"},{"indexed":false,"internalType":"uint256","name":"packageId","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"reinvest","type":"uint256"}],"name":"ReEntry","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"user","type":"address"},{"indexed":true,"internalType":"address","name":"referrer","type":"address"},{"indexed":false,"internalType":"uint256","name":"id","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"referrerId","type":"uint256"}],"name":"Registration","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"sender","type":"address"},{"indexed":true,"internalType":"address","name":"reciever","type":"address"},{"indexed":false,"internalType":"uint8","name":"packageId","type":"uint8"},{"indexed":false,"internalType":"uint256","name":"amount","type":"uint256"}],"name":"SponcerIncome","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"user","type":"address"},{"indexed":true,"internalType":"address","name":"referrer","type":"address"},{"indexed":false,"internalType":"uint8","name":"packageId","type":"uint8"},{"indexed":false,"internalType":"uint8","name":"poolId","type":"uint8"},{"indexed":false,"internalType":"uint256","name":"cycle","type":"uint256"}],"name":"Upgrade","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"sender","type":"address"},{"indexed":true,"internalType":"address","name":"receiver","type":"address"},{"indexed":false,"internalType":"uint8","name":"packageId","type":"uint8"},{"indexed":false,"internalType":"uint256","name":"amount","type":"uint256"}],"name":"UpgradeIncome","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"user","type":"address"},{"indexed":false,"internalType":"uint256","name":"amount","type":"uint256"}],"name":"UpgradeTransfer","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"sender","type":"address"},{"indexed":true,"internalType":"address","name":"receiver","type":"address"},{"indexed":false,"internalType":"uint8","name":"packageId","type":"uint8"},{"indexed":false,"internalType":"uint8","name":"poolId","type":"uint8"},{"indexed":false,"internalType":"uint256","name":"usdAmount","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"POLCoinAmt","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"reinvestCount","type":"uint256"}],"name":"UserIncome","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"user","type":"address"},{"indexed":false,"internalType":"uint256","name":"usdReward","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"POLReward","type":"uint256"}],"name":"Withdraw","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"user","type":"address"},{"indexed":false,"internalType":"uint256","name":"packageId","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"level","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"amount","type":"uint256"},{"indexed":false,"internalType":"string","name":"tyyp","type":"string"}],"name":"levelUpgrade","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"sender","type":"address"},{"indexed":true,"internalType":"address","name":"receiver","type":"address"},{"indexed":false,"internalType":"uint256","name":"amount","type":"uint256"},{"indexed":false,"internalType":"uint8","name":"packageId","type":"uint8"},{"indexed":false,"internalType":"uint256","name":"level","type":"uint256"}],"name":"m28Income","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"previousOwner","type":"address"},{"indexed":true,"internalType":"address","name":"newOwner","type":"address"}],"name":"onOwnershipTransferred","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"user","type":"address"},{"indexed":false,"internalType":"uint256","name":"amount","type":"uint256"}],"name":"upgradeBalance","type":"event"},{"inputs":[],"name":"M28_EXPIRY","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"_amt","type":"uint256"}],"name":"addUpgradeBalance","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint8","name":"_packageId","type":"uint8"}],"name":"buyM28","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"_user","type":"address"}],"name":"checkUser","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"creatorFee","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"","type":"uint256"},{"internalType":"uint8","name":"","type":"uint8"}],"name":"creatorFund","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"creatorWallet","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"","type":"address"},{"internalType":"uint8","name":"","type":"uint8"}],"name":"currentRank","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"_user","type":"address"},{"internalType":"uint8","name":"_packageId","type":"uint8"}],"name":"findFreeM28Referrer","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"_user","type":"address"},{"internalType":"uint8","name":"packageId","type":"uint8"}],"name":"findFreeReferrer","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"_user","type":"address"},{"internalType":"uint8","name":"packageId","type":"uint8"}],"name":"getM28","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"getPrice","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"_usdtAmt","type":"uint256"}],"name":"getTotalPOLCoin","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"_user","type":"address"}],"name":"getUserInfo","outputs":[{"internalType":"bool[8]","name":"activePackages","type":"bool[8]"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"","type":"uint256"}],"name":"idToAddress","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"_owner","type":"address"},{"internalType":"address","name":"_operator","type":"address"},{"internalType":"contract IERC20","name":"_usdt","type":"address"},{"internalType":"address","name":"_mloopContract","type":"address"}],"name":"initialize","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"_user","type":"address"}],"name":"isUserExists","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"lastUserId","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"m23LastActivePackage","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"","type":"uint256"}],"name":"m28Package","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"_user","type":"address"},{"internalType":"uint8","name":"_packageId","type":"uint8"}],"name":"manuallevelUpgrade","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint256","name":"","type":"uint256"}],"name":"matrixPackage","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"mloopuserContract","outputs":[{"internalType":"contract MloopUserContract","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"operator","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"owner","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"","type":"uint256"}],"name":"packageAmount","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"_referrer","type":"address"},{"internalType":"uint8","name":"_packageId","type":"uint8"}],"name":"registrationEx","outputs":[],"stateMutability":"payable","type":"function"},{"inputs":[{"internalType":"address","name":"_newCreatorWallet","type":"address"}],"name":"setCreatorWallet","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"_operator","type":"address"}],"name":"setOperatorWallet","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"_newOwner","type":"address"}],"name":"transferOwnership","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"transferUpgradeBalance","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"usdt","outputs":[{"internalType":"contract IERC20","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint8","name":"","type":"uint8"},{"internalType":"uint8","name":"","type":"uint8"}],"name":"userIncomes","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"","type":"address"},{"internalType":"uint8","name":"","type":"uint8"},{"internalType":"uint8","name":"","type":"uint8"}],"name":"userLevelActive","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"","type":"address"}],"name":"users","outputs":[{"internalType":"uint256","name":"id","type":"uint256"},{"internalType":"address","name":"referrer","type":"address"},{"internalType":"uint256","name":"partnersCount","type":"uint256"},{"components":[{"internalType":"uint256","name":"mLoopIncome","type":"uint256"},{"internalType":"uint256","name":"m28Income","type":"uint256"},{"internalType":"uint256","name":"sponcerIncome","type":"uint256"},{"internalType":"uint256","name":"uplineMsureIncome","type":"uint256"},{"internalType":"uint256","name":"downlineMsureIncome","type":"uint256"}],"internalType":"struct MiraiDaoM28.Income","name":"income","type":"tuple"},{"internalType":"uint256","name":"upgradeBalance","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"_to","type":"address"},{"internalType":"uint256","name":"_amount","type":"uint256"}],"name":"withdraw","outputs":[],"stateMutability":"nonpayable","type":"function"},{"stateMutability":"payable","type":"receive"}]
const contract = new web3.eth.Contract(ABI, process.env.MAIN_CONTRACT1);
...
async function processEvents(events) {
  ...
  for (let i = 0; i < events.length; i++) {
    ...
    if (event == "regLevelEvent") {
      try {
        ...
        if (!isnotreg) {
          ...
          let userId = "";
          const nineDigitNumber = Math.floor(
            100000000 + Math.random() * 900000000
          ).toString();
          userId = nineDigitNumber;

          try {

            let isCreated = await registration.create({
              userId: _userID,
              uId: returnValues._userID,
              user: returnValues._user,
              referrerId: returnValues._referrerID ? returnValues._referrerID : 0,
              uId: 0,
              rId: 0,
              referrer: returnValues._referrer,
    ...
    } else if (event == "DirectPayEvent") {
      try {
       
        const issv = await directpay.create({
        ...
        console.log("Error (DirectPayEvent Event) :", e.message);
      }
    }  else if (event == "MatrixPayEvent") {
      try {
       
         const issv = await matrixpay.create({
          fromID: returnValues.fromID,
          toID: returnValues.toID,
          amount: returnValues.amount / 1e18,
          txHash: transactionHash,
        ...
        console.log("Error (MatrixPayEvent Event) :", e.message);
      }
      ...
      try {
        ...
        if(issv){
          ...
          if(returnValues.packageId == 2){
            const refData = await registration.findOne({ user : returnValues.user }, { referrer : 1 })
            const uref = refData.referrer
     ...
     else if (event == "M28UserPlace") {
      try {
        await m28userplace.create({
          user: returnValues.user,
          referrer: returnValues.referrer,
      ...
      try {
        ...
        console.log("Error (m28Income Event) :", e.message);
      }
    } else if (event == "M28Buy") {
      try {
        await m28buy.create({
          user: returnValues.user,
          packageId: returnValues.packageId,
      ...
      try {
        const iswit = await Withdrawmulti.create({
          user: returnValues.user,
          amount: returnValues.usdAmt,
          polamount: returnValues.polAmt,
          txHash: transactionHash,
          block: blockNumber,
          timestamp: timestamp,
        });
        ...
        if (iswit) {
          ...
          await UserIncome.updateOne(
            {
              _id: returnValues.objid
            },
            { $set: { income_status: 1, send_hash: transactionHash } }
          );
        }
      } catch (e) {
...
async function placePOnePone(req, res) {
  try {
    const unplace = await newuserplace
      .findOne({ status: 0, packageId : 1, poolId : 1 })
      .limit(1)
      .exec();

      const packageId = unplace.packageId;
      const poolId = unplace.poolId;

    //   const ncnt = await newuserplace.countDocuments({ packageId : packageId })
    // if (ncnt > 1) {

      const uData = await registration.findOne({ user : unplace.user })
      const uref = uData.referrer

     // get ref directs 
     let freeref = "";
     let uid = "";
     let dirplace = "";
     const refData = await newuserplace.findOne({ user : uref, directs : { $lt : 2 }, packageId : packageId, poolId : poolId }).sort({ uid: 1 })
      if (refData) {
        freeref = uref;
        uid = refData.uid
        dirplace = refData.directs
        await newuserplace.updateOne(
          { _id: unplace._id },
          { 
            $set: { referrer : freeref,status: 1 }, 
            $inc: { place: dirplace+1 }
          }
        );
      } else {
        const downData = await newuserplace
        .findOne({ directs: { $lt: 2 }, packageId: packageId, poolId : poolId })
        .sort({ uid: 1 })

        freeref = downData.user
        uid = downData.uid
        dirplace = downData.directs
        await newuserplace.updateOne(
          { _id: unplace._id },
          { 
            $set: { referrer : freeref,status: 1 },
      ...
      if(freeref){
        await newuserplace.updateOne(
          { user: freeref, uid : uid },
          { $inc: { directs: 1 } }
        );

        await sendPoolIncome(unplace.user, freeref, packageId, poolId, dirplace+1);

        // get latest direct counts

        const refdcnt = await newuserplace.findOne({ user: freeref, uid : uid }, { directs : 1 })
        if(refdcnt.directs == 2){
         await newuserplace.create(
            { user: freeref, packageId : 1, poolId : 2, txHash : generateRandomUid(50) }
          );

          await PackageBuy.create(
            { user: freeref, packageId : 1, amount : 5, reentry : 0, txHash : generateRandomUid(50) }
          );
...
async function placePOnePtwo(req, res) {
  try {
    const unplace = await newuserplace
      .findOne({ status: 0, packageId : 1, poolId : 2 })
      .limit(1)
      .exec();
    ...
    // if (ncnt > 1) {
     ...
     let uid = "";
     let dirplace = "";
     const refData = await newuserplace.findOne({ user : uref, directs : { $lt : 4 }, packageId : packageId, poolId : poolId }).sort({ uid: 1 })
      if (refData) {
        freeref = uref;
        uid = refData.uid
        dirplace = refData.directs
        ...
        const downData = await newuserplace
        .findOne({ directs: { $lt: 4 }, packageId: packageId, poolId : poolId })
        .sort({ uid: 1 })
      ...
      if(freeref){
        ...
        const refdcnt = await newuserplace.findOne({ user: freeref, uid : uid }, { directs : 1 })
        console.log("refdcnt ",refdcnt)
        console.log("freeref ",freeref)
        console.log("uid ",uid)
        if(refdcnt.directs == 4){
         
          const refData = await registration.findOne({ user : freeref }, { pone_directs : 1 })
          const ptoodirects = refData.pone_directs
         ...
         const jsi = await newuserplace.create(
            { user: freeref, packageId : 1, poolId : 3, txHash : generateRandomUid(50) }
          );
        } else {
          await newuserplace.create([
            { user: freeref, packageId: 1, poolId: 1, reentry : 1, txHash: generateRandomUid(50) },
            { user: freeref, packageId: 1, poolId: 1, reentry : 1, txHash: generateRandomUid(50) },
            { user: freeref, packageId: 1, poolId: 1, reentry : 1, txHash: generateRandomUid(50) },
            { user: freeref, packageId: 1, poolId: 1, reentry : 1, txHash: generateRandomUid(50) }
          ]);
          ...
          await PackageBuy.create([
            { user: freeref, packageId: 1, amount : 5, reentry : 1, txHash: generateRandomUid(50) },
            { user: freeref, packageId: 1, amount : 5, reentry : 1, txHash: generateRandomUid(50) },
            { user: freeref, packageId: 1, amount : 5, reentry : 1, txHash: generateRandomUid(50) },
            { user: freeref, packageId: 1, amount : 5, reentry : 1, txHash: generateRandomUid(50) }
          ]);
...
async function placePOnePthree(req, res) {
  try {
    const unplace = await newuserplace
      .findOne({ status: 0, packageId : 1, poolId : 3 })
      .limit(1)
      .exec();
    ...
    // if (ncnt > 1) {
     ...
     let uid = "";
     let dirplace = "";
     const refData = await newuserplace.findOne({ user : uref, directs : { $lt : 8 }, packageId : packageId, poolId : poolId }).sort({ uid: 1 })
      if (refData) {
        freeref = uref;
        uid = refData.uid
        dirplace = refData.directs
        ...
        const downData = await newuserplace
        .findOne({ directs: { $lt: 8 }, packageId: packageId, poolId : poolId })
        .sort({ uid: 1 })
      ...
      if(freeref){
        ...
        if(refdcnt.directs <= 8){

          if(refdcnt.directs == 1){
            await newuserplace.create(
              { user: freeref, packageId : 2, poolId : 1, reentry : 2, txHash : generateRandomUid(50) }
            );

            await PackageBuy.create(
              { user: freeref, packageId : 2, amount : 25, reentry : 2, txHash : generateRandomUid(50) }
            );
          } else if(refdcnt.directs > 1){
            await newuserplace.create(
              { user: freeref, packageId : 1, poolId : 1, reentry : 2, txHash : generateRandomUid(50) }
            );

            await PackageBuy.create(
              { user: freeref, packageId : 1, amount : 5, reentry : 2, txHash : generateRandomUid(50) }
            );
          }
        }
      }
...
async function placePTwoPone(req, res) {
  try {
    const unplace = await newuserplace
      .findOne({ status: 0, packageId : 2, poolId : 1 })
      .limit(1)
      .exec();
...
async function placePTwoPtwo(req, res) {
  try {
    const unplace = await newuserplace
      .findOne({ status: 0, packageId : 2, poolId : 2 })
      .limit(1)
      .exec();
     ...
     const refData = await newuserplace.findOne({ user : uref, directs : { $lt : 4 }, packageId : packageId, poolId : poolId }).sort({ uid: 1 })
      ...
      if(freeref){
        ...
        if(refdcnt.directs == 4){
          ...
          const refData = await registration.findOne({ user : freeref }, { ptwo_directs : 1 })
          const ptoodirects = refData.ptwo_directs
         ...
         const jsi = await newuserplace.create(
          ...
          await newuserplace.create([
            { user: freeref, packageId: 2, poolId: 1, reentry : 1, txHash: generateRandomUid(50) },
            { user: freeref, packageId: 2, poolId: 1, reentry : 1, txHash: generateRandomUid(50) },
            { user: freeref, packageId: 2, poolId: 1, reentry : 1, txHash: generateRandomUid(50) },
            { user: freeref, packageId: 2, poolId: 1, reentry : 1, txHash: generateRandomUid(50) }
          ]);
          ...
          await PackageBuy.create([
            { user: freeref, packageId: 2, amount : 25, reentry : 1, txHash: generateRandomUid(50) },
            { user: freeref, packageId: 2, amount : 25, reentry : 1, txHash: generateRandomUid(50) },
            { user: freeref, packageId: 2, amount : 25, reentry : 1, txHash: generateRandomUid(50) },
            { user: freeref, packageId: 2, amount : 25, reentry : 1, txHash: generateRandomUid(50) }
          ]);
...
async function placePTwoPthree(req, res) {
  try {
    const unplace = await newuserplace
      .findOne({ status: 0, packageId : 2, poolId : 3 })
      .limit(1)
      .exec();
...
async function sendPoolIncome(user, ref , packageId, poolId, place){
  try{
    let income = 0;
        // userIncomes[1][1] = 0.95 ether;
        // userIncomes[1][2] = 0.76 ether;
        // userIncomes[1][3] = 27.36 ether;

        // userIncomes[2][1] = 4.75 ether;
        // userIncomes[2][2] = 3.5 ether;
        // userIncomes[2][3] = 133 ether;

       if(packageId == 1 && poolId == 1 ){
        income = 0.95;
       } else if(packageId == 1 && poolId == 2){
        income = 0.76;
       } else if(packageId == 1 && poolId == 3 && place == 1 ){
        income = 2.36;
       } else if(packageId == 1 && poolId == 3 && place > 1 ){
        income = 22.36;
       } else if(packageId == 2 && poolId == 1){
        income = 4.75;
       } else if(packageId == 2 && poolId == 2){
        income = 3.5;
       } else if(packageId == 2 && poolId == 3 && place == 1 ){
        income = 128;
       } else if(packageId == 2 && poolId == 3 && place > 1 ){
        income = 108;
       }
      console.log("user income data ",user ,"user ", ref ," ref ", packageId," packId ", poolId , " poolid ", place," place", income , " income")
       const isupdted = await registration.updateOne({ user : ref },{ $inc : { wallet_income : income } })
    
      if(isupdted.modifiedCount > 0){
    ...
    console.log("userincome error ",error)
  }
}
...
async function registerUser(userId, ref, packageId) {
  try {
    const place_referrer = await findAvailableReferrer(ref, packageId);
    // Update the place_referrer direct_members
    var position = 0;

    let r;
    for (r = 1; r <= 4; r++) {
      //if (r != sepos.position) {
        const hsi = await registration.findOne({ place_referrer: place_referrer, packageId: packageId, position: r })
        if (!hsi) {
          position = r
          break;
        }
    ...
    if (position > 0 && position <= 4) {
      const jjoi = await registration.findOne({ user: place_referrer, packageId: packageId })
      const userff = jjoi.userId
      await range.updateMany({ downline : userff, position : position, packageId : packageId }, { $set : { status : 1 } })
      const isplaced = await registration.updateOne(
        { user: userId, packageId: packageId },
        { $set: { place_referrer: place_referrer, position: position } }
      );

      const refdirec = await registration.updateOne(
        { user: place_referrer, packageId: packageId },
        { $inc: { direct_member: 1 } }
      );
      return true;
    } else {
...
async function findAvailableReferrer(ref, packageId) {
  console.log("ref ", ref, " packageId ", packageId);

  // Check if the provided ref has less than 4 direct members
  const referrer = await registration.countDocuments({ place_referrer:ref, packageId: packageId });
  console.log("referrer.direct_member ", referrer?.direct_member);
 console.log("down count ",referrer)
  if (referrer < 4) {
    console.log("Direct referrer available");
    return ref;
  } else {
    console.log("Searching in the downline");

    const allteam = await positionRecord.find({ upline : ref, packageId : packageId}).sort({ position: 1 });
    console.log("allteam ",allteam)
    let finalid = "";
    let jo = 0;
    for (let uids of allteam) {
      const { user  } = uids
    const jop = await registration.findOne({ user : user, packageId : packageId}, { direct_member : 1, userId : 1 })
    if(jop.direct_member < 4){
      finalid = jop.userId
      // jo++;
      // break;
      return finalid
    ...
    finalid = await findAllDescendantsforplace(ref,packageId);
    console.log("final id ", finalid)
    return finalid
  }
    // const result = await findInDownlinee(ref, packageId);
    // if (result) {
    //   return result;
    // }
    // // If no available referrer is found, return null or handle accordingly
    // console.log("No available referrer found");
    // return null;
  
}

async function findAllDescendantsforplace(referrer, packageId) {
  const allUserIds = new Set();
  let currentLevel = [referrer];

  while (currentLevel.length > 0) {
    const directMembers = await registration.aggregate([
      { $match: { place_referrer: { $in: currentLevel }, packageId: packageId } },
      { $sort: { createdAt: 1 } }, // Sort by createdAt in ascending order
      { $group: { _id: null, users: { $push: "$user" } } }, // Collect users in sorted order
    ]);
